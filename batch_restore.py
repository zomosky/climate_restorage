...
CONFIG_YAML: str | None = "/Users/zmy/pycharm/climate_pipeline/climate_restorage/config/jobs/gfs_zarr_china.yaml"
...
DATE_START: str = "20260110"   # 起始日期
DATE_END:   str = "20260113"   # 截止日期（含）

# --- 起报周期过滤（None = 不过滤；例如只取 [0, 12] UTC 起报）--
# 例：CYCLES: list[int] | None = [0, 12]
CYCLES: list[int] | None = [12]
